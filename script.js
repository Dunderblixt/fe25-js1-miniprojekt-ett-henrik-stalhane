document.addEventListener('DOMContentLoaded', () => {
	...
	const fontSize = 10;
	const bigger = 5;
	const startRGB = { r: 40, g: 255, b: 255 };
	const colorStep = 40; 
	...
	divEtt.style.backgroundColor = '#33ff57ff';
	...
	for (let n = 0; n <= 9; n++) {
        ...
        if ( n === 4 ) {
            siffernamn.style.backgroundColor = '#33ff57ff';
        }
        else if (n % 2 === 0) {
            siffernamn.style.backgroundColor = '#b42b2bff';
        }
        else {
            siffernamn.style.backgroundColor = '#ff5733ff';
        }   
	}
    ...
    divTvå.style.backgroundColor = '#33ff57ff';
    ...
    divTre.style.backgroundColor = '#33ff57ff';
